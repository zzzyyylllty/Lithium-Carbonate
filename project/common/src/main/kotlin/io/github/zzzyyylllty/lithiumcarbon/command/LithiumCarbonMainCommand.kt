...
@CommandHeader(
    name = "lithiumcarbon",
    aliases = ["li2co3","lc"],
    permission = "lithiumcarbon.command.main",
    description = "Main Command for LithiumCarbon.",
    permissionMessage = "",
...
object LithiumCarbonMainCommand {
    ...
    val about = subCommand {
        execute<CommandSender> { sender, context, argument -> //
            sender.sendComponent("<gradient:aqua:yellow>LithiumCarbon</gradient> <#ccccff>$pluginVersion")
